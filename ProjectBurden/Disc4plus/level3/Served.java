...
public class Served extends Event{
    ...
    public String toString(){
		...
		if(super.isHuman()){
        return super.toString()+" "+ super.getCustomer().getID() + " served by server "+ super.getServer();
		}
		else{
			return super.toString()+" "+ super.getCustomer().getID() + " served by self-check "+ super.getServer();
		}
		/*}
		else{
