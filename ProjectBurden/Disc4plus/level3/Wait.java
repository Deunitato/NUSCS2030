...
public class Wait extends Event{
    ...
    public String toString(){
		...
		if(super.isHuman()){
        return super.toString()+" "+ super.getCustomer().getID() + " waits to be served by server "+ super.getServer();
		}
		else{
			return super.toString()+" "+ super.getCustomer().getID() + " waits to be served by self-check "+ super.getServer();
		}
		/*}
		else{
